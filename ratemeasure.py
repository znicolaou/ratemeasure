...
parser.add_argument("--mechanism", type=str, required=False, default='mechanisms/gri30.cti', dest='mechanism', help='Cantera mechanism file. Default mechanisms/gri30.cti.')
parser.add_argument("--Npoints", type=float, required=False, default=5e3, dest='Npoints', help='Number of time points to output. Default 5e3.')
parser.add_argument("--experiments", type=str, required=False, default='experiments/air.dat', dest='experiments', help='File containing a line [tmax temperature pressure initials] for each experimental condition.  Initials is a list of pairs [index] [proportion] specifying species with nonzero initial mole fraction. Default experiments/air.dat.')
parser.add_argument("--measure", type=int, required=False, default=37, dest='measure', help='the index of the reaction whose rate is measured. Default 37.')
parser.add_argument("--sensitivity", type=int, required=False, default=2, dest='sensitivity', help='the index of the reaction whose rate is measured. Default 2.')
parser.add_argument("--remove", type=int, required=False, default=40, dest='remove', help='The number of reactions to randomly remove. Default 40.')
parser.add_argument("--retain", type=int, required=False, default=40, dest='retain', help='The number of reactions to retain. Default 40.')
parser.add_argument("--seed", type=int, required=False, default=1, dest='seed', help='The random seed. Default 1.')
parser.add_argument("--ktol", type=float, required=False, default=1e-6, dest='ktol', help='The tolerance in k relative to k0 in the minimization. Default 1e-6.')
parser.add_argument("--out", type=int, choices=[0,1], required=False, default=1, dest='out', help='Flag for outputting: 1 for observation and fit output. Default 1.')
parser.add_argument("--maxes", nargs='+', type=int, required=False, default=[2], dest='maxes', help='Indices of concentration maxima to include in error. -1 for none. Default 2.')
parser.add_argument("--yields", nargs='+', type=int, required=False, default=[-1], dest='yields', help='Indices of concentration yields to include in error. -1 for none. Default -1.')
